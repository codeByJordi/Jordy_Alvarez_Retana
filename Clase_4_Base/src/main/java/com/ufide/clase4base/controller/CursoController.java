...
public class CursoController {
        ...
        /*@PostMapping
        public String guardar(@ModelAttribute("curso") Curso curso, RedirectAttributes ra) {
                cursoService.guardar(curso); //lo guarda en la base de datos
                ra.addFlashAttribute("ok", "Curso guardado correctamente"); //da un mensaje y nos pasa a otro html
                return "redirect:/cursos"; //lo redirige al cursos.html
        }*/
        ...
        public String actualizar(@PathVariable Long id,
                ...
                curso.setId(id); //importante, se debe settear el id
                cursoService.guardar(curso);
