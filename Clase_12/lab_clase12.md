...
|---|---|
| `cursosapp/` | Proyecto de S11 actualizado (login, roles, `@PreAuthorize`, 403, CRUD de Usuarios, sesiones, recuperación de contraseña), con los archivos nuevos de este lab descritos en `CorsConfig.java`. |
